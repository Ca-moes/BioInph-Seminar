...
public class ExampleParseMessages {
    ...
    public static void main(String[] args) {
         ...
         * instances of
         * HAPI's "Message" object. In this case, we are using a "GenericParser", which
         * is able to
         ...
         * components1, so we
         * will cast it as such. The ADT_A01 class extends from Message, providing
         * specialized
         * accessors for ADT^A01's segments.
         * 
         * HAPI provides several versions of the ADT_A01 class, each in a different
         * package (note
